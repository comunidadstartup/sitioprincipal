...
export default class NovStep extends Component<Props, State> {
		...
		return (
			...
			>
				<CaminoCard
					...
					date="Nov, 2021"
					text="Inicio de la comunidad con meta a alcanzar los primeros 50 integrantes
                            y postular los primeros líderes para los primeros grupos temáticos de
                            retroalimentación"
				/>
			</Section>
		);
