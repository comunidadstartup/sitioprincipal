...
export default class MotivacionContentV extends Component<Props, State> {
	...
	render() {
		return (
			...
			>
				<Text type="P">
					Esas son las riquezas de los <b>valores</b>, de la <b>cultura</b>, o
					en general, las riquezas del <b>recurso de la humanidad</b>.
					Invirtamos en <b>nuestra sociedad</b>. Invirtamos en el futuro de
