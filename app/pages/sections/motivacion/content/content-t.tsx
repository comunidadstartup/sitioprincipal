...
export default class MotivacionContentIII extends Component<Props, State> {
	...
	render() {
		return (
			...
			>
				<Text type="P">
					Estos son valores que he encontrado yo en mí mismo, que de alguna u
					otra manera los he encontrado en mis compatriotas. Y es este potencial
					de ver gente trabajando en equipo por un bien común sin individualismo
					o afán de lucro o provecho la motivación detrás de la creación de esta
					comunidad.
				</Text>
			</Section>
		);
