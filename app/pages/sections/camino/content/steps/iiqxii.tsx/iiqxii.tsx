...
export default class Step2QXII extends Component<Props, State> {
		...
		return (
			...
			>
				<CaminoCard
					...
					date="Q2, 2022"
					text={`Tener desarrollado una importante parte 
					de la plataforma incluyendo el listado de startups, 
					el listado de grupos, un buscador de temas y un buscador 
					de talento, fundadores y cofundadores. Haber alcanzado más de 500 miembros
					distribuidos principalmente en talento y
					minoritariamente en fundadores o
					cofundadores`}
				/>
			</Section>
		);
