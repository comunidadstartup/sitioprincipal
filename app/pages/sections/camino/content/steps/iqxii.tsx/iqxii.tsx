...
export default class Step1QXII extends Component<Props, State> {
		...
		return (
			...
			>
				<CaminoCard
					...
					date="Q1, 2022"
					text="Comenzar programa de voluntariado bajo modalidad 
                    académica con vistas a desarrollar un programa de certificados"
				/>
			</Section>
		);
	}
