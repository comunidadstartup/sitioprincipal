...
export default class Step4QXII extends Component<Props, State> {
		...
		return (
			...
			>
				<CaminoCard
					...
					date="Q4, 2022"
					text="Síguenos por nuestros medios y redes 
					primeros grupos temáticos de sociales para estar pendientes"
				/>
			</Section>
		);
	}
