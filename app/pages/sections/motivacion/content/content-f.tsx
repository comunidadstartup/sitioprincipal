...
export default class MotivacionContentI extends Component<Props, State> {
	...
	render() {
		return (
			...
			>
				<Text type="P">
					Costa Rica es un país que en lo profundo no tiene par en
					Centroamérica, ni quizás en el resto de la región Iberoamericana
				</Text>
			</Section>
		);
	}
